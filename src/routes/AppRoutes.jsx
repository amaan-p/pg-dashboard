...
import TeamLiveOrders2 from "../pages/TeamLiveOrders2";
import TeamPastOrders from "../pages/TeamPastOrders";
...
const AppRoutes = () => {
  ...
  return (
    <Routes>
      ...
      >
        <Route path="live-orders" element={<TeamLiveOrders2 {...dashboardProps} />} />
        <Route path="past-orders" element={<TeamPastOrders {...dashboardProps} />} />
