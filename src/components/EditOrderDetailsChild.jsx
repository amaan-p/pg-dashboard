                    ...
                    <div className="mt-4 grid grid-cols-3 gap-7">
                      {
                        capDetails.map((cap) => (
                          <>
                            <input key={cap.id + '-name'} className="p-2 rounded-lg " />
                            <input key={cap.id + '-material'} className="p-2 rounded-lg text-center" />
                            <input key={cap.id + '-size'} className="p-2 rounded-lg text-center" />
                          </>
                        ))
                      }
                    </div>
